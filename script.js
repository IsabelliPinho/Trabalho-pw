...
let primeiro = document.getElementById("seleciona") 
...
async function converterMoedas(){
    ...
    let inputdoReal = Number(document.getElementById("input").value)
    let inputMoedas = document.getElementById("inputM")
    let textoReal = document.getElementById("texto-real")

    if (primeiro.value === "real") {
        
        if (select.value === "dolar") {
            textoReal.innerHTML = inputdoReal
            let valorEmDolares = inputdoReal / dolar
            inputMoedas.innerHTML=valorEmDolares.toLocaleString("en-US", {style: "currency", currency: "EUA"})

        } 
        if (select.value === "euro"){
            let valorEmEuros = inputdoReal / euro
            inputMoedas.innerHTML=valorEmEuros.toLocaleString("de-DE", {style: "currency", currency: "EUR"})
        }
        if (select.value === "real") {
            inputMoedas.innerHTML=inputdoReal.toLocaleString("pt-br", {style: "currency", currency: "BRL"})
    ...
    if (primeiro.value === "dolar"){
        ...
        let dolarvezesReal = dolar * inputdoReal
        ...
        if (select.value === "dolar") {
            inputMoedas.innerHTML = inputdoReal.toLocaleString("en-US", {style: "currency", currency: "USD"})
        }
    }
    if (primeiro.value === "euro") {
        
        let eurovezesReal = euro * inputdoReal
        ...
        if (select.value === "euro") {
            inputMoedas.innerHTML = inputdoReal.toLocaleString("de-DE", {style: "currency", currency: "EUR"}) 
        }
    ...
    textoReal.innerHTML= inputdoReal.toLocaleString("pt-br",{style: "currency", currency: "BRL"})
}
